                    ...
                    <div className="col-lg-8 col-xl-8 w-100">
                      ...
                      {Array.isArray(orderData) && orderData.length > 0 ? (
                        orderData.map((order, index) => {
                          ...
                          return (
                            <>
                              <div className={`card mt-2 ${order.product_status.toLowerCase() === 'rejected' ? 'card-disabled' : ''}`} style={{ borderRadius: "10px" }}>
                                    ...
                                    <div className="card-body">
                                      <div className="row">
                                        ...
                                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center flex-column">
                                          <p className="text-muted mb-0 small">Item Color:</p>
                                          <p>{order.product_color}</p>

                                        </div>
                                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center flex-column">
                                          <p className="text-muted mb-0 small">Payment Mode:</p>
                                        ...
                                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                                          <p className="text-muted mb-0 small">{order.product_price}</p>
                                        </div>
                                      </div>
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="card-footer border-0 px-4 py-2" style={{ backgroundColor: "#E4D6D2", borderRadius: "50px" }}>
                                          <h5 className="d-flex align-items-center justify-content-end text-dark text-uppercase mb-0">
                                            Total paid: <span className="h2 mb-0 ms-2">{totalPaid} RS</span>
                                          </h5>
                                        </div>
                                      </div>
                                    </div>
